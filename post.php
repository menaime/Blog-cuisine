...
<?php
// Vérifie si le paramètre 'postid' est défini dans l'URL
if (isset($_GET['postid'])) 
{
  $edit_post_id_visit = $_GET['postid'];

  // Sélectionne les informations de l'article en fonction de son ID
  ...
  // Met à jour le compteur de visites en ajoutant 1
  ...
  if (!$result_sql_edit_post_visit)
  {
    ...
    die("Description de l'erreur : " . mysqli_error($dbconnection));
  }
  else
  {
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      if (isset($_GET['postid'])) 
      {
        ...
        // Sélectionne les informations de l'article à afficher
      ...
      {
        // Redirige vers la page d'accueil si le paramètre 'postid' n'est pas défini
      ...
      <div class="col-lg-8">
        ...
        <!-- Author -->
        <?php 
        // Sélectionne les informations de l'auteur de l'article
        ...
        <p class="lead">
          ...
          Par <a href="#"><?php echo $view_users_name; ?></a> <br>Web developer <a href="#">VirtuaPHP</a>
        </p>

        <hr>

        <!-- Date/Time -->
        <p>Publié le <?php echo $view_post_date; ?></p>

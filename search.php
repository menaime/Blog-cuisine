      ...
      <div class="col-md-8">
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            ...
            <a href="post.php?postid=<?= $view_post_id; ?>" class="btn btn-primary">Lire la suite &rarr;</a>
          </div>
          <?php 
          ...
          <div class="card-footer text-muted">
            ...
            Par <a href="#"><?php echo $view_users_name; ?></a> <br>Développeur Web <a href="#">Blog culinaire</a>
          ...
          <li class="page-item">
            <?php 
              ...
              if ($page > 1) {
                $previous= $page - 1;
            ?>
            <a class="page-link" href="search.php?page=<?php echo $previous ?>&search=<?php echo $search_text ?>">&larr; Précédent</a>
             <?php } ?>
          </li>
          <li class="page-item">
            <?php 
              if ($page < $allpages) {
                $next= $page + 1;
            ?>
            <a class="page-link" href="search.php?page=<?php echo $next ?>&search=<?php echo $search_text ?>">Suivant &rarr;</a>
            <?php } ?>
          </li>
        </ul>

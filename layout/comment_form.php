    <?php
      ...
      if (isset($_POST['save_comment']))
      {
        ...
        if (isset($selected_post_page)) {
          $add_comm_posid = $selected_post_page;
      } else {
        echo "Erreur : Impossible de récupérer l'identifiant de la page.";
      }
      

        $sql_add_comment = "INSERT INTO comments(postid, comm_autor, comm_email, comm_text, comm_status,comm_date) VALUES('$add_comm_autor', '$add_comm_email', '$add_comm_text', '0', '$current_date' )";
            ...
            <form method="post" action="" onsubmit="myFunction()">
              <div class="form-group">
                <?php 
                 ...
                 ?>
                <label for="autor" class="col-form-label">Auteur:</label>
                ...
                <?php 
                 ...
                 <p class="lead">
                   <img src="admin/images/users/<?php echo $success_login_image_admin; ?>" class="zoom3" alt="User Image" width="50" align="left" hspace="5">
                      <a href="#"><?php echo $success_login_name_admin; ?></a> <br>Web developer <a href="#">Blog cuisine</a>
